...
\end{equation*}
Secondly, we could consider $\EC$ under the natural action of a group $G$ of Möbius transformations which is conjugate to $\PSL{\Z}$ and whose transformations are represented by certain matrices\footnote{Compare also \Mumford{}, p.\ 88, Recipe III.} over the ring of Gaussian integers $\Z[\ii]$ with determinant 1:
\begin{equation*}
