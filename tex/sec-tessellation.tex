...
\end{equation*}
Secondly, we could consider $\EC$ under the natural action of a group $G$ of Möbius transformations which is conjugate to $\PSL{\Z}$ and whose transformations are represented by matrices of a certain form over the ring of Gaussian integers $\Z[\ii]$ having determinant 1:
\begin{equation*}
