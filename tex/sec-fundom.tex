...
\begin{remark}
The relation between fundamental sets and fundamental regions is the following: If $\mathcal{F} \subseteq \mathcal{S}$ is a fundamental region, then its topological closure $\overline{\mathcal{F}}$ contains a fundamental set $\mathcal{F}^\ast$:
