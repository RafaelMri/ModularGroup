...
This section is about the great work of Douglas Arnold and Jonathan Rogness, ``Möbius transformations revealed'' \cite{arnold2008mobius}, in which the authors give a characterization of Möbius transformations in terms of stereographic projections and rigid motions of spheres in 3D-space.\footnote{See also http://www.ima.umn.edu/$\sim$arnold/moebius}
...
\caption[Stereographic projection and the map $z \mapsto \reci{z}$]{Inversion $z \mapsto \reci{z}$ can be interpreted as rotation of the Riemann sphere by $180^{\circ}$ around the $x_1$ axis. It maps the upper to the lower half-plane (left) and turns the unit disk inside out (right).}
