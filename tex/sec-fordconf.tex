...
\end{equation*}
with $m \ge 0$, $k_j \in \Z$ and $\ell_j \ge 1$. Because for $\ell \ge 1$, $T^\ell$ and $(TU^0)^{\ell-1}T$ are \emph{identical} as words, we can for sure notate $w$ alternatively in the form (\ref{eqn_ConFracTUWord}).
\end{proof}
...
\begin{corollary}
\label{cor_TRRelationsIndiskPaths}
