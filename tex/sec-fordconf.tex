...
\end{equation}
is satisfied for infinitely many $p,q \in \Z$. In contrast to that, if $k < \sqrt{5}$, then there are irrational numbers $\alpha$, such that (\ref{eqn_RatApprox}) is satisfied for only finitely many $p,q \in \Z$.
\end{theorem}
