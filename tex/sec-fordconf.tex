...
In \Lehner{}, p.\ 61ff., the approximations of $\pi$ obtained by its \emph{regular continued fraction expansion} are discussed in a similar fashion and some interesting historical details can be found there as well.
\end{remark}
...
\begin{remark}
An elementary proof of Theorem~\ref{thm_RatApprox}, relying on continued fraction expansions of irrational numbers, can be found in \Lehner{}, §14. An alternative proof, based purely on geometric considerations on Ford circles, is given in \Ford{}.
\end{remark}
