...
\end{equation*}
More coefficients can be found when looking up the sequence A133593 at the \emph{On-Line Encyclopedia of Integer Sequences (OEIS)}\footnote{https://oeis.org}. The convergents of this continued fraction give, by Corollary~\ref{cor_ConFracModTrans}, rise to a sequence of Modular transformations:
